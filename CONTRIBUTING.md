...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/henryhst/azure-agent.git
   cd azure-agent
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/henryhst/azure-agent
   ```
...
- **Issues** - Report bugs and request features via [GitHub Issues](https://github.com/henryhst/azure-agent/issues)
- **Discussions** - Ask questions in [GitHub Discussions](https://github.com/henryhst/azure-agent/discussions)
